...
class XFAHandler:
    ...
    def get_fields_from_template(self, elem=None, result=None, parent=None):
        ...
        if (
            ...
            if (not re.search("delete", elem_name.lower())
                ...
                # This section will need to be ripped out and moved to the eSTAR class
    ...
    def get_fields_from_dataset(self, fields):
        ...
        Reads the field list generated by get_fields_from_template(), finds each of the fields in the dataset namespace,
        and extracts the field value
        """
...
class FormHandler:
    ...
    def get_attachments(self, pdf):
        ...
        if '/Names' in pdf_root.keys() and '/EmbeddedFiles' in pdf_root['/Names'].keys():
            attachments = None if '/Names' not in pdf_root['/Names']['/EmbeddedFiles'].keys() else [x for n, x in enumerate(pdf_root['/Names']['/EmbeddedFiles']['/Names']) if n % 2 == 1]
